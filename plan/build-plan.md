...
| 1.3 | **Built** Member Durable Object: alarms for arrival, repeat, quiet, turn prompt; recompute from zone; storage cleared when the member stops, leaves, dies, or is deleted; reconciliation cron; heartbeat ping | arch §6 | Silence drill part 2 passes; Healthchecks shows a live check |

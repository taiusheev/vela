...
- The family member who sets Vela up (the **organiser**) and everyone in the family's Vela group. Vela's first message in that group links this notice.
...
2. **To keep the light:** tell the family when the person has answered. When a day stays quiet, send the organiser the facts (when the morning message went out, when the person usually answers) and the names and numbers of the nearby contacts who have agreed, so the organiser can decide what to do.
...
- **Organisers** also receive notices on quiet days, the words passed on under purpose 4, the weekly read, and the details of the nearby contacts who have agreed.
- **A nearby contact** sees only a message an organiser chooses to send them on a quiet day. They never see answers.
- **The founder** reads the family's exchanges during the pilot, to make sure Vela works as it should and to write and send the weekly read, and records whether each nearby contact agreed. Every time the founder opens or changes a family's records, on Vela's admin page or directly in the database, it is logged, and you can ask to see that log. When something needs the founder's attention, such as words passed on under purpose 4 or a weekly read ready to check, Vela tells the founder in a private Telegram chat with a link to the admin page; that chat never contains what anyone in the family wrote. Vela's software is built with the help of an AI coding assistant, which works with test data and never with your family's messages.
...
| Nearby contacts' details | Until the contact or the organiser removes them. Deleted within 7 days if the contact says no, and 14 days after they were added if the contact has not said yes |
| Records of consent | As long as we keep the information they cover |
| Delivery records: what was sent to whom, when, and whether it arrived | 24 months, and deleted with the person's information; the message text inside them is deleted after 30 days |
| Log of AI calls: which call, when, whether it worked, its cost | 24 months, with names removed when the person's information is deleted; what the AI returned is deleted after 30 days |
...
- **Stop.** The person the light is for can simply say **"stop"** in the chat. Morning messages and the light pause at once, and the organiser is told: "[Name] asked to pause. Nothing is wrong with the app." Saying **"start"** brings it back. Anyone else can tell the founder, or their organiser, who passes it on; the founder then removes them from Vela. A family member can also simply leave the family's Vela group: Vela notices, stops including them in the turns, and deletes their information 30 days later. An organiser who leaves the group stays an organiser until they tell the founder.

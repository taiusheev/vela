...
- **The organiser's payment app** (Wise, Revolut, PayPal) processes the pilot fee as an independent company chosen by the organiser.
- **[NOTES TOOL]** holds call notes, research answers and the fee ledger under family codes. It is a processor and must be named here and in the privacy notice before the first onboarding call.

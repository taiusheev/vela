...
> **Superseded on 2026-09-13 by Appendix A of [`05-product-spec-v2.md`](05-product-spec-v2.md).** The bot in `bot/` is to be updated to that appendix before the pilot.

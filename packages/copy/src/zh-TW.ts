 ...
 * (訊息, 設定, 群組, 略過, 家族群組) rather than mainland terms. The kept-light member is always
 * named or called 這位家人, never 他 or 她, and nothing uses 監控 or 追蹤, for the same reasons as
 * the English rules. The stop and start words the member is told to say (「停」, 「開始」) must stay
 * in step with the zh-TW keywords of `parseParentCommand` in @vela/core.
 *
...
export const zhTW: Record<keyof typeof en, string> = {
  ...
  "arrival.vote": "請按一個選項。",
  "arrival.hello": "今天家人沒有新的消息。您今天早上好嗎？",
  ...
  "consent.request":
    "{organiser}想為您留一盞燈。每天早上，會有一位家人問您一件事；您回答了，家人就知道您一切都好。如果到了傍晚還沒有回覆，{organiser}就會知道該打電話給您。您隨時都可以說「停」。",
  "consent.yes": "好，沒問題",
  "consent.no": "不用了，謝謝",
  ...
  "group.ask_queued": "明天已經有{asker}的提問了。這則先保留，之後的早上再送出。",
  ...
  "group.answer_vote": "{name}投給：{choice}",
  ...
  "onboarding.done":
    "設定完成。請把這個連結傳給{name}： {link} 然後把我加進家族群組，讓家人可以輪流提問。",

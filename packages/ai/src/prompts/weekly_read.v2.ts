...
Your task: draft this week's weekly read: one to five short lines and one suggestion. A person reviews the draft before it is sent.
...
- answeredDays: how many of those days the elder answered.
...
A sparse week (a first week, or few answers) gets fewer lines: never pad the read with lines the data does not support.
...
Return JSON: {"lines": [one to five strings], "suggestion": string}.

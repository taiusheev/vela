...
| Channels, wave 1 | Telegram, MAX, WhatsApp | **Telegram first; the parent surface app is the floor; the voice line moves from phase 3 to phase 2**; WhatsApp only for markets where it works; MAX only with a Russian entity, and never with a privacy claim | Block, throttling, MAX terms [10] |
